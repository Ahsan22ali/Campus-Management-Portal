    ...
    public partial class Subject : System.Web.UI.Page
    {
        ...
        protected void btnAdd_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (dt.Rows.Count == 0)
                {
                    string query = "Insert into Subject values('" + ddlClass.SelectedItem.Value + "','" + txtSubject
                        .Text.Trim() + "')";
        ...
        protected void GridView1_RowUpdating(object sender, GridViewUpdateEventArgs e)
        {
            try
            {
                ...
                fn.Query("Update Subject set ClassId ='" + classId + "',SubjectName='"+subjectName+"' where SujectId='" + SubjId + "' ");
