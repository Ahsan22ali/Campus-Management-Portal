<%@ Page Title="" Language="C#" MasterPageFile="~/Teacher/TeacherMst.Master" AutoEventWireup="true" CodeBehind="StudentAttendenceDetails.aspx.cs" Inherits="WebApplication1.Teacher.StudentAttendenceDetails" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
     <div class="container p-4" style="background-color: #f0f8ff">
    <h3 class="text-center mb-4">1Mark Student Attendance</h3>
